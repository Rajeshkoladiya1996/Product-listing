                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="text-sm-right">
                                    <a class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2" href="{{route('front.category.addcategory')}}">
                        ...
                        <div id="categorylist">
                            @include('front.category.categorylist')
                        </div>
                    </div>
                </div>
            </div> <!-- end col -->
...
$('body').on('click','.btn-delete-vendor',function(e){
   var id = $(this).data('id');
   var url = "{{URL::to('category/destroy')}}"+'/'+id;
    swal({
